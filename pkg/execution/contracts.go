// Package execution contains the stable contracts shared by Veto's routing
// and execution layers. Concrete transports belong in adapter packages and
...
type TaskExecutor interface {
	Execute(context.Context, string, ExecutionOptions) Result
}
