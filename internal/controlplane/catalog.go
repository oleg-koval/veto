...
func DefaultCatalog() Catalog {
	return Catalog{actions: []ActionSpec{
		...
		{ID: "disable", Label: "Disable", Command: "disable", Category: "Workspace", Description: "Exclude a model from routing.", Flags: []FlagSpec{{Name: "model", Value: "string", Required: true, Description: "Model name to exclude from routing."}}},
		{ID: "enable", Label: "Enable", Command: "enable", Category: "Workspace", Description: "Restore a model to routing eligibility.", Flags: []FlagSpec{{Name: "model", Value: "string", Required: true, Description: "Model name to re-enable."}}},
...
func loginFlags() []FlagSpec {
	return []FlagSpec{
		...
		{Name: "mode", Value: "string", Default: "api-key", Description: "api-key, browser (OpenRouter OAuth), subscription, or runtime."},
