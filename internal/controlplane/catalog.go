...
func DefaultCatalog() Catalog {
	return Catalog{actions: []ActionSpec{
		...
		{ID: "verified-runs", Label: "Verified Runs", Command: "verified-runs", Category: "Diagnostics", Description: "Inspect local evidence-backed outcome receipts.", Subcommands: []string{"list", "report"}, Flags: []FlagSpec{{Name: "json", Value: "bool", Description: "Emit JSON for the report subcommand."}}},
