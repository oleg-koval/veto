...
func DefaultCatalog() Catalog {
	return Catalog{actions: []ActionSpec{
		...
		{ID: "setup", Label: "Setup", Command: "setup", Category: "Workspace", Description: "Discover and approve skills.", Flags: []FlagSpec{{Name: "auto-approve", Value: "bool", Description: "Approve all discovered skills in the selected directory."}, {Name: "directory", Value: "path", Description: "Skill directory to scan; defaults to ~/.claude/skills."}}},
